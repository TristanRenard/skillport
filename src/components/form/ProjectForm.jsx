      ...
      <div className="w-full h-full bg-noise bg-fixed rounded-3xl flex flex-row justify-center items-center">
        <div className="flex flex-col w-3/4 p-8 gap-8 justify-center items-center">
          ...
          <div className="flex w-full flex-col gap-2 text-tertiary">
            ...
            <input type="text" id="imageUrl" value={project.imageUrl} onChange={(e) => setProject({ ...project, imageUrl: e.target.value })} onBlur={update} placeholder="Image URL" className="w-full bg-[#df9884] placeholder:text-quinary placeholder:font-light placeholder:italic p-2 px-3 rounded-xl outline-none border-tertiary border-2 autofill:bg-[#df9884]" autoComplete="off"
            />
          </div>
          <div className="flex w-full flex-col gap-2 text-tertiary">
            <label className="text-lg" htmlFor="text">Title</label>
            <input type="text" id="text" value={project.titre} placeholder="Project Title" onChange={(e) => setProject({ ...project, titre: e.target.value })} onBlur={update} className="uppercase w-full bg-[#df9884] placeholder:text-quinary placeholder:font-light placeholder:capitalize placeholder:italic p-2 px-3 rounded-xl outline-none border-tertiary border-2"
            />
          </div>
          <div className="flex w-full flex-col gap-2 text-tertiary">
            <label className="text-lg" htmlFor="text">Tech Stack</label>
            <input type="text" id="text" value={project.techno} placeholder="Tech Stack" onChange={(e) => setProject({ ...project, techno: e.target.value })} onBlur={update} className="w-full bg-[#df9884] placeholder:text-quinary placeholder:font-light placeholder:italic p-2 px-3 rounded-xl outline-none border-tertiary border-2"
            />
          </div>
          <div className="flex w-full flex-col gap-2 text-tertiary">
            <label className="text-lg" htmlFor="text">Date</label>
            <input type="text" id="text" value={project.date} placeholder="Date" onChange={(e) => setProject({ ...project, date: e.target.value })} onBlur={update} className="w-full bg-[#df9884] placeholder:text-quinary placeholder:font-light placeholder:italic p-2 px-3 rounded-xl outline-none border-tertiary border-2"
            />
          </div>
          <div className="flex w-full flex-col gap-2 text-tertiary">
